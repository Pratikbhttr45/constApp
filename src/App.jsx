        ...
        <>
            ...
            <nav className="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
                <div className="container">
                    <a className="navbar-brand" href="#page-top"><img src="assets/img/logo1.png" alt="..." /></a>
                    ...
                    <div className="collapse navbar-collapse" id="navbarResponsive">
                        <ul className="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                            ...
                            {/* <li className="nav-item"><a className="nav-link" href="#team">Teams</a></li> */}
            ...
            <header className="masthead">
                <div className="container">
                    <div className="masthead-subheading">Crafting Your Vision</div>
                    <div className="masthead-heading text-uppercase"> Build your dream,<span className="span"> With US</span></div>
                    <p id="pratik"> MasterCraft Builders is a full-service construction company that specializes in custom home building, remodeling, and commercial construction. Our skilled craftsmen work closely with clients to bring their vision to life, delivering high-quality results that exceed expectations.</p>
                ...
                <div className="container">
                    ...
                    <div className="row text-center">
                        <div className="col-md-4">
                            ...
                            <h4 className="my-3">Construction </h4>
